...
raw_data = pd.read_excel('wafertest.xlsx',sheet_name = "wafertest")
raw_data=raw_data.drop(labels=["session","Edge","Doughnut","Ring"],axis=1)
sdarray=raw_data
...
twoDarray_train = sdarray_train_np.reshape((sdarray_train_np.shape[0], 30, 55))
twoDarray_test = sdarray_test_np.reshape((sdarray_test_np.shape[0], 30, 55))
